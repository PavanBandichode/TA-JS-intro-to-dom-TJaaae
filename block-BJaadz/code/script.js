...
console.log(typeof heading, "Q.2");
...
allHrsArray.forEach((x) => (x.style.color = "antiquewhite"));
...
// document
//   .querySelector("hr.image")
//   .forEach((elm) => (elm.style.border = "2px solid purple"));
// Hide the box number 17 (last box).
let lastBlock = document.querySelector(".seventeen");
...
console.log(box16.parentNode, "line 52");
console.log(box16.childNodes, "line 53");
console.log(box16.previousSibling, "line 54");
console.log(box16.nextSibling, "line 55");
console.log(box16.firstChild, "line 56");
console.log(box16.lastChild, "line 57");
console.log(box16.previousElementSibling, "line 58");
console.log(box16.nextElementSibling, "line 59");
console.log(box16.firstElementChild, "line 60");
console.log(box16.lastElementChild, "line 61");
